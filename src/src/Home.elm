...
import Html                 exposing (Html, button, div, text, sup, sub, u, br, b)
...
title_box sys = case sys of
    None ->
        ...
        , style "top"                "50px" , style "left"    "-125px"
    ...
    Simple ->
        div
        [ style "height"             "50px" , style "width"    "400px"
        , style "color" "#c0c0c0", style "background-color" "transparent"
    ...
    Two ->
        div
        [ style "height"             "50px" , style "width"    "500px"
        , style "background-color" "transparent" , style "color"  "#6bff56"
        , style "top"                "150px" , style "left"    "-125px"
        , style "position"        "absolute" , style "font-size" "40px"
        , style "border" "0px", style "font-weight" "bold", style "vertical-align" "middle"
    ...
    W ->
        div
        [ style "height"             "100px" , style "width"    "700px"
...
rules_box sys = case sys of
    None ->
        ...
        , style "top"                "200px" , style "left"    "-125px"
    ...
    Simple ->
        div
        [ style "height"             "130px" , style "width"    "500px"
        , style "background-color" "#0f0f0f" , style "color"  "#ffffff"
        , style "top"                "300px" , style "left"    "-125px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "border" "0px" , style "text-align" "left" , style "padding" "10px"
    ...
    Two ->
        div
        [ style "height"             "150px" , style "width"    "500px"
        , style "background-color" "#0f0f0f" , style "color"  "#ffffff"
        , style "top"                "325px" , style "left"    "-125px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "border" "0px" , style "text-align" "left" , style "padding" "10px"
    ...
    W ->
        ...
        [ style "height"             "100px" , style "width"    "500px"
        , style "background-color" "#0f0f0f" , style "color"  "#ffffff"
        , style "top"                  "110px" , style "left"    "-125px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "border" "0px" , style "text-align" "left" , style "padding" "10px"
    ...
    C ->
        div
        [ style "height"             "125px" , style "width"    "500px"
        , style "background-color" "#0f0f0f" , style "color"  "#ffffff"
...
terms_box sys = case sys of
    None ->
        div
        [ style "height"             "190px" , style "width"    "490px"
        , style "background-color" "#ffffff" , style "color"  "#0f0f0f"
        , style "top"                "50px" , style "left"    "425px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "border" "5px solid" , style "text-align" "left"
        , style "padding" "10px", style "border-color" "#c5e8b7"
        ] [ b [] [text "The set of untyped lambda terms:"], br [] [], text "Variable - if x ∈ V, then x ∈ Λ"
            , br [] [], text "Application - if M,N ∈ Λ then (MN) ∈Λ"
            , br [] [], text "Abstraction - if x ∈ V and M ∈ Λ, then (λ x . M). ∈ Λ"
            , br [] [], text "Application is left associative, whereas Abstraction is right associative.  As well as this, application takes prescident over abstraction"]

    Simple ->
        div
        [ style "height"             "270px" , style "width"    "600px"
        , style "background-color" "#ffffff" , style "color"  "#0f0f0f"
        , style "top"                "375px" , style "left"    "425px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "border" "5px solid" , style "text-align" "left"
        , style "padding" "10px", style "border-color" "#c0c0c0"
        ] [ b [] [text "Pre-typed Terms:"], br [] [], text "Variable - if α ∈ V, then α ∈ Λ",sup [][text "→"]
            , br [] [], text "Application - if M,N ∈ Λ",sup [][text "→"], text "then (MN) ∈Λ",sup [][text "→"]
            , br [] [], text "Abstraction - if x ∈ 𝕍, σ in 𝕋, and M ∈ Λ",sup [][text "→"], text  ", then (λ  x : σ . M). ∈ Λ",sup [][text "→"]
            , br [] [], b [] [text "Derivation Rules:"], br[] [], text "variable - Γ ⊢ x : σ  if x : σ ∈ Γ"
            , br [] [], text "application - ", u [] [text "Γ ⊢ M : σ → τ ⠀⠀ Γ ⊢ N : σ"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ MN : τ"
            , br [] [], text "abstraction - ", u [] [text "⠀⠀Γ,x : σ ⊢ M : τ⠀⠀"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ λ  x : σ . M:σ→τ" ]

    P ->
        div
        [ style "height"             "375px" , style "width"    "490px"
        , style "background-color" "#ffffff" , style "color"  "#0f0f0f"
        , style "top"                "225px" , style "left"    "650px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "border" "5px solid" , style "text-align" "left"
        , style "padding" "10px", style "border-color" "#ff302d"
        ] [ b [] [text "Derivation Rules:"], br[] [], text "sort - 0 ⊢ * : ☐"
            , br [] [], text "variable", u [] [text "⠀⠀⠀Γ ⊢ A : s⠀⠀⠀"], text "⠀⠀if x ∉Γ ", br [] [] , text "⠀⠀⠀⠀⠀⠀⠀Γ,x : A ⊢ x : A"            , br [] [], text "weak - ", u [] [text "Γ ⊢ A : B ⠀⠀ Γ ⊢ C : s"], text "⠀⠀if x ∉Γ ", br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ MN : B"
            , br [] [], text "formation - ", u [] [text "Γ ⊢ A : * ⠀⠀ Γ,x : A ⊢ B : s"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ Πx : A. B : s"
            , br [] [], text "appliaction - ", u [] [text "Γ ⊢ M : Πx :A . B ⠀⠀ Γ ⊢ N : A"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ MN : B[x:= N]"
            , br [] [], text "abstraction - ", u [] [text "⠀⠀Γ,x : A ⊢ M : B⠀⠀Γ ⊢ Πx :A . B : s"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ λ  x : A . M):Πx:A . B"
            , br [] [], text "conversion - ", u [] [text "⠀⠀Γ ⊢ A : B⠀⠀Γ ⊢ B' : s"], text "⠀⠀if B =",sub [][text "β"], text"B'", br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ A : B'" ]

    Two ->
        div
        [ style "height"             "490px" , style "width"    "600px"
        , style "background-color" "#ffffff" , style "color"  "#0f0f0f"
        , style "top"                "300px" , style "left"    "575px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "border" "5px solid" , style "text-align" "left"
        , style "padding" "10px", style "border-color" "#6bff56"
        ] [ b [] [text "Pre-typed Terms:"], br [] [], text "Variable - if α ∈ V, then α ∈ Λ",sub [][text "2"]
            , br [] [], text "Application A - if M,N ∈ Λ",sub [][text "2"], text ", then (MN) ∈Λ",sup [][text "2"]
            , br [] [], text "Application B - if M ∈ Λ",sub [][text "2"], text "and σ ∈𝕋, then (Mσ) ∈Λ",sup [][text "2"]
            , br [] [], text "Abstraction A - if x ∈ V, σ in 𝕋",sub [][text "2"], text " and M ∈ Λ",sub [][text "2"], text  ", then (λ  x : σ . M). ∈ Λ",sub [][text "2"]
            , br [] [], text "Abstraction B - if σ ∈ 𝕍 and M in Λ",sub [][text "2"], text ", then (λ  σ : * . M). ∈ Λ",sub [][text "2"]
            , br [] [], b [] [text "Derivation Rules:"], br[] [], text "variable - Γ ⊢ x : σ  if Γ is λ2 context, and x : σ ∈ Γ"
            , br [] [], text "formation - Γ ⊢ B : *  if Γ is λ2 context, B ∈ 𝕋2, and every free type variable in B is in Γ"
            , br [] [], text "application 1 - ", u [] [text "Γ ⊢ M : σ → τ ⠀⠀ Γ ⊢ N : σ"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ MN : τ"
            , br [] [], text "application 2 - ", u [] [text "Γ ⊢ M : (Πα : * .A ) ⠀⠀ Γ ⊢ B : *"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ MB : A[α := B]"
            , br [] [], text "abstraction 1 - ", u [] [text "⠀⠀Γ,x : σ ⊢ M : τ⠀⠀"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ λ  x : σ . M:σ→τ"
            , br [] [], text "abstraction 2 - ", u [] [text "⠀⠀Γ,α : * ⊢ M : A⠀⠀"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ (λ  α : * . M):(Πα : * .A )" ]

    W_ ->
        div
        [ style "height"             "460px" , style "width"    "550px"
        , style "background-color" "#ffffff" , style "color"  "#0f0f0f"
        , style "top"                "210px" , style "left"    "-125px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "border" "5px solid" , style "text-align" "left"
        , style "padding" "10px", style "border-color" "#74c0ff"
        ] [text "The set of kinds (𝕂) is as follows:", br [] [], text "Type Kind  - * ∈ 𝕂 ", br [] [], text "Abstraction Kind  - (* → *)  ∈ 𝕂 "
        , br [] [], b [] [text "Derivation Rules:"], br[] [], text "sort - 0 ⊢ * : ☐"
            , br [] [], text "variable", u [] [text "⠀⠀⠀Γ ⊢ A : s⠀⠀⠀"], text "⠀⠀if x ∉Γ ", br [] [] , text "⠀⠀⠀⠀⠀⠀⠀Γ,x : A ⊢ x : A"
            , br [] [], text "weak - ", u [] [text "Γ ⊢ A : B ⠀⠀ Γ ⊢ C : s"], text "⠀⠀if x ∉Γ ", br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ MN : B"
            , br [] [], text "formation - ", u [] [text "Γ ⊢ A : s ⠀⠀ Γ ⊢ B : s"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ A → B : s"
            , br [] [], text "appliaction - ", u [] [text "Γ ⊢ M : A → B ⠀⠀ Γ ⊢ N : A"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ MN : B"
            , br [] [], text "abstraction - ", u [] [text "⠀⠀Γ,x : A ⊢ M : B⠀⠀Γ ⊢ A → B : s"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ λ  x : A . M):A → B"
            , br [] [], text "conversion - ", u [] [text "⠀⠀Γ ⊢ A : B⠀⠀Γ ⊢ B' : s"], text "⠀⠀if B =",sub [][text "β"], text"B'", br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ A : B'" ]
    ...
    W ->
        ...
        [ style "height"             "190px" , style "width"    "490px"
        , style "background-color" "#ffffff" , style "color"  "#0f0f0f"
        , style "top"                "525px" , style "left"    "-125px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "border" "5px solid" , style "text-align" "left"
    ...
    C ->
        div
        [ style "height"             "400px" , style "width"    "490px"
        , style "background-color" "#ffffff" , style "color"  "#0f0f0f"
        , style "top"                "-15px" , style "left"    "775px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "border" "5px solid" , style "text-align" "left"
        , style "padding" "10px", style "border-color" "#3c3c3c"
        ] [ b [] [text "Derivation Rules:"], br[] [], text "sort - 0 ⊢ * : ☐"
            , br [] [], text "variable", u [] [text "⠀⠀⠀Γ ⊢ A : s⠀⠀⠀"], text "⠀⠀if x ∉Γ ", br [] [] , text "⠀⠀⠀⠀⠀⠀⠀Γ,x : A ⊢ x : A"            , br [] []
            , br [] [], text "weak - ", u [] [text "Γ ⊢ A : B ⠀⠀ Γ ⊢ C : s"], text "⠀⠀if x ∉Γ ", br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ MN : B"
            , br [] [], text "formation - ", u [] [text "Γ ⊢ A : s",sub[][text "1"] ,text" ⠀⠀ Γ,x : A ⊢ B : s"],sub[][text "2"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ Πx : A. B : s",sub[][text "2"]
            , br [] [], text "appliaction - ", u [] [text "Γ ⊢ M : Πx :A . B ⠀⠀ Γ ⊢ N : A"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ MN : B[x:= N]"
            , br [] [], text "abstraction - ", u [] [text "⠀⠀Γ,x : A ⊢ M : B⠀⠀Γ ⊢ Πx :A . B : s"], br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ λ  x : A . M):Πx:A . B"
            , br [] [], text "conversion - ", u [] [text "⠀⠀Γ ⊢ A : B⠀⠀Γ ⊢ B' : s"], text "⠀⠀if B =",sub [][text "β"], text"B'", br [] [] , text "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀Γ ⊢ A : B'" ]
...
syntax_box sys = case sys of
    None ->
        div
        [ style "height"             "200px" , style "width"     "500px"
        , style "background-color" "#c5e8b7" , style "color"   "#ffffff"
        , style "top"                "350px" , style "left"       "-125px"
        , style "position"        "absolute" , style "font-size"  "20px"
        , style "padding"             "10px" , style "text-align" "left"
    ...
    Simple ->
        div
        [ style "height"             "200px" , style "width"     "500px"
        , style "background-color" "#c0c0c0" , style "color"  "#ffffff"
        , style "top"                "500px" , style "left"    "-125px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "text-align" "left" , style "padding" "10px"
    ...
    P ->
        ...
        , style "top"                "500px" , style "left"    "50px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "text-align" "left" , style "padding" "10px"
    ...
    W_ ->
        div
        [ style "height"         "175px" , style "width"     "500px"
        , style "background-color" "#74c0ff" , style "color"  "#ffffff"
        , style "top"                "-50px" , style "left"    "525px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "text-align" "left", style "padding" "10px"
        ...
        , br [][], text "as an example, a type or constructor would have kind *, and a proper constructor would have kind * -> *"]
    ...
    PW_ ->
        ...
        , style "top"                "250px" , style "left"    "625px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "text-align" "left", style "padding" "10px"
        ] [ text ""]
    ...
    P2 ->
        ...
        , style "top"                "400px" , style "left"    "625px"
        , style "position"        "absolute" , style "font-size" "20px"
        , style "text-align" "left" , style "padding" "10px"
        ] [ text ""]
